...
const RestaurantOnboarding = () => {
    ...
    const handleCreateWebsite = async () => {
        try {
            ...
            setNewWebsiteUrl(`https://dash77.netlify.app/${domainName}`);
                ...
                <div className="success-popup-overlay">
                    <div className="success-popup">
                        ...
                        <button
                            ...
                            onClick={() => window.location.href = 'https://dash77.netlify.app/manage'}
                        >
                            Go to Dashboard
                        </button>
                    </div>
                    ...
                    <div className="onboarding-step domain-step">
                        ...
                        {domainAvailable !== null && (
                            <div className={`domain-status ${domainAvailable ? 'available' : 'unavailable'}`}>
                                {domainAvailable
                                    ? <><span className="status-icon">✓</span> dash77.netlify.app/{domainName} is available!</>
                    ...
                    <div className="onboarding-step summary-step">
                        ...
                        <div className="summary-card">
                            <div className="summary-section">
                                ...
                                <p className="domain-preview">dash77.netlify.app/{domainName}</p>
                            </div>
